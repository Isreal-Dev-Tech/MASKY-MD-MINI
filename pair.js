...
👺 *ᴍᴀsᴋʏ ᴍᴅ ʙʏ ɪsʀᴇᴀʟ ᴛᴇᴄʜ* 👺
        ...
        await socket.sendMessage(sender, {
            ...
            buttons: [
                {
                    buttonId: `${socket.userConfig.PREFIX}menu`,
                    buttonText: { displayText: "📜 MENU" },
                    type: 1
                },
                {
                    buttonId: `${socket.userConfig.PREFIX}ping`,
                    buttonText: { displayText: "📡 PING" },
                    type: 1
                },
                {
                    buttonId: `${socket.userConfig.PREFIX}owner`,
...
───────────────────────────────
╭──❰ 🌟 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ❱──╮
│ 🔗 *Channel:* https://whatsapp.com/channel/0029Vb6jJTU3AzNT67eSIG2L
╰───────────────────────────╯

⫷⫷⫷👺 𝐈𝐒𝐑𝐀𝐄𝐋 𝐓𝐄𝐂𝐇 𝐃𝐄𝐕 𝟐𝟎𝟐𝟓 👺⫸⫸⫸
`;

        // ✅ Working buttons for npm:baileys-mod
        await socket.sendMessage(sender, {
            ...
            buttons: [
                {
                    buttonId: `${socket.userConfig.PREFIX}owner`,
                    buttonText: { displayText: "👑 BOT CREATOR" },
                    type: 1
                },
                {
                    buttonId: `${socket.userConfig.PREFIX}ping`,
                ...
                {
                    buttonId: `${socket.userConfig.PREFIX}alive`,
                    buttonText: { displayText: "⚙️ STATUS" },
                    type: 1
                }
            ],
            headerType: 4,
        ...
        await socket.sendMessage(sender, { text: "❌ Error displaying menu." });
    }
};
...
END:VCARD`;
        ...
        // 1️⃣ Send the owner contact first
        await socket.sendMessage(sender, {
            contacts: {
        ...
        await socket.sendMessage(sender, {
            ...
            buttons: [
                ...
                {
                    buttonId: `${socket.userConfig.PREFIX}alive`,
                    buttonText: { displayText: '⚙️ BOT INFO' },
                    type: 1
                }
            ],
            headerType: 4,
        ...
        console.error('Error in handleOwner:', err);
        await socket.sendMessage(sender, { text: '❌ Failed to send owner info.' });
    }
};
