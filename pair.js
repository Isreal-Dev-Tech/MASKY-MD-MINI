...
👺 *ᴍᴀsᴋʏ ᴍᴅ ʙʏ ɪsʀᴇᴀʟ ᴛᴇᴄʜ ᴅᴇᴠ* 👺`;
    ...
    await socket.sendMessage(sender, {
    image: { url: socket.userConfig.BUTTON_IMAGES.ALIVE }, // image file or URL
    caption: "🤖 *MASKY MINI ONLINE!*\n\nSelect an option below 👇",
    ...
    headerType: 4, // 4 = image header type
    viewOnce: false,
    quoted: msg // optional, to reply to a message
});
},
...
⫷⫷⫷👺 𝐈𝐒𝐑𝐀𝐄𝐋 𝐓𝐄𝐂𝐇 𝐃𝐄𝐕 𝟐𝟎𝟐𝟓 👺⫸⫸⫸`;
    ...
    caption: menuText,
    footer: `⚡ ${socket.userConfig.BOT_FOOTER}`, // ← Missing comma fixed here
    buttons: [
...
// Then send the image + button menu
await socket.sendMessage(sender, {
